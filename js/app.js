(() => {
    ...
    function initSliders() {
        if (document.querySelector(".catalog-slider")) new core(".catalog-slider", {
            modules: [ Navigation ],
            observer: true,
            observeParents: true,
            slidesPerView: 4,
            ...
            speed: 800,
            navigation: {
                prevEl: ".arrows-slider__left",
                nextEl: ".arrows-slider__right"
            },
            breakpoints: {
                320: {
                    slidesPerView: 1,
        ...
        if (document.querySelector(".slider-big__slider")) new core(".slider-big__slider", {
            modules: [ Navigation ],
            observer: true,
            observeParents: true,
            slidesPerView: 1,
        ...
        if (document.querySelector(".description-product__images")) {
    ...
    for (i = 0; i < acc.length; i++) acc[i].addEventListener("click", (function() {
        ...
        if ("block" === panel.style.display) panel.style.display = "none"; else panel.style.display = "block";
    }));
    var tag = document.createElement("script");
    tag.src = "https://www.youtube.com/iframe_api";
    document.body.appendChild(tag);
    window.onYouTubeIframeAPIReady = function() {
        var videoModules = document.querySelectorAll(".video__wrapper");
        videoModules = Array.prototype.slice.call(videoModules);
        videoModules.forEach(initializeVideoModule);
    };
    function initializeVideoModule(videoModule) {
        var player = new YT.Player(videoModule.querySelector(".video__placeholder"), {
            ...
            events: {
                onStateChange: function(event) {
                    ...
                    if (isEnded) {
                        player.destroy();
                        videoModule.querySelector(".video__layer").innerHTML = '<div class="video__placeholder"></div>';
    ...
    const openCharacteristics = document.querySelector(".characteristics__button");
    if (openCharacteristics) {
        const characteristicsBody = document.querySelector(".characteristics__header");
        openCharacteristics.addEventListener("click", (function(e) {
            openCharacteristics.classList.toggle("show-body");
            characteristicsBody.classList.toggle("show-body");
        }));
    }
    window["FLS"] = true;
    isWebp();
